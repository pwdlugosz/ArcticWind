...
namespace ArcticWind.Libraries
{
    ...
    //public class LibraryStat : Library
    //{


    //    public LibraryStat(Host Host)
    //        : base(Host, "STAT")
    //    {
    //    }
    ...
    //    /// <summary>
    //    /// Provides methods for probability distributions
    //    /// </summary>
    //    public static class Distributions
    //    {

    //        public const double PI = 3.14159265359;
    //        public const double SQRT_2_PI = 2.50662827463;
    //        public const double SQRT_2 = 1.41421356237;
    //        public const double SQRT_PI = 1.77245385091;
    ...
    //        {
    //            return Math.Exp(-0.5 * Value * Value) / SQRT_2_PI;
    //        }
    ...
    //        // Log normal //
    //        public static double LogNormalPDF(double Value, double Mu, double Sigma)
    //        {
    //            double x = (Math.Log(Value) - Mu) / Sigma;
    //            return Math.Exp(-0.5 * x * x) / (SQRT_PI * Value);
    //        }

    //        public static double LogNormalCDF(double Value, double Mu, double Sigma)
    //        {
    //            double x = (Math.Log(Value) - Mu) / Sigma;
    //            return NormalCDF(x);
    //        }

    //        public static double LogNormalINV(double PValue, double Mu, double Sigma)
    //        {
    ...
    //            return Math.Exp(NormalINV(PValue) * Sigma + Mu);
    ...
    //        // Wiebul Distribution //
    //        public static double WeibullPDF(double Value, double Alpha, double Beta)
    //        {
    //            return Alpha * Math.Pow(Value, Alpha - 1) * Math.Exp(-Math.Pow(Value / Beta, Alpha)) * Alpha / Math.Pow(Beta, Alpha);
    //        }

    //        public static double WeibullCDF(double Value, double Alpha, double Beta)
    //        {
    //            return 1 - Math.Exp(-Math.Pow(Value / Beta, Alpha));
    //        }

    //        public static double WeibullINV(double PValue, double Alpha, double Beta)
    //        {
    //            return Math.Pow(-Math.Log(1 - PValue), 1 / Alpha) * Beta;
    //        }

    //        // Pareto Distribution //
    //        public static double ParetoPDF(double Value, double Alpha, double Beta)
    //        {
    //            return Alpha * Math.Pow(Beta, Alpha) / Math.Pow(Value, Alpha + 1);
    //        }

    //        public static double ParetoCDF(double Value, double Alpha, double Beta)
    //        {
    //            return 1 - Math.Pow(Beta / Value, Alpha);
    //        }

    //        public static double ParetoINV(double PValue, double Alpha, double Beta)
    //        {
    //            return Beta / Math.Pow(1 - PValue, 1 / Alpha);
    //        }

    //        // Uniform //
    //        public static double UniformPDF(double Value, double Lower, double Upper)
    //        {
    //            return 1 / (Upper - Lower);
    //        }

    //        public static double UniformCDF(double Value, double Lower, double Upper)
    //        {
    //            return (Value - Lower) / (Upper - Lower);
    //        }

    //        public static double UniformINV(double PValue, double Lower, double Upper)
    //        {
    //            return PValue * (Upper - Lower) + Lower;
    //        }
    ...
    //            sb.AppendLine(string.Format("NormalPDF(0.5): {0}", NormalPDF(0.5)));
    //            sb.AppendLine(string.Format("NormalCDF(0.5): {0}", NormalCDF(0.5)));
    //            sb.AppendLine(string.Format("NormalINV(0.75): {0}", NormalINV(0.75)));

    //            sb.AppendLine(string.Format("LogNormalPDF(2.5, 2, 1.5): {0}", LogNormalPDF(2.5, 2, 1.5)));
    //            sb.AppendLine(string.Format("LogNormalCDF(2.5, 2, 1.5): {0}", LogNormalCDF(2.5, 2, 1.5)));
    //            sb.AppendLine(string.Format("LogNormalINV(0.75, 2, 1.5): {0}", LogNormalINV(0.75, 2, 1.5)));

    //            sb.AppendLine(string.Format("StudentsTPDF(0.5, 10): {0}", StudentsTPDF(0.5, 10)));
    //            sb.AppendLine(string.Format("StudentsTCDF(0.5, 10): {0}", StudentsTCDF(0.5, 10)));
    //            sb.AppendLine(string.Format("StudentsTINV(0.75, 10): {0}", StudentsTINV(0.75, 10)));

    //            sb.AppendLine(string.Format("GammaPDF(0.5, 1.25, 1.5): {0}", GammaPDF(0.5, 1.25, 1.5)));
    //            sb.AppendLine(string.Format("GammaCDF(0.5, 1.25, 1.5): {0}", GammaCDF(0.5, 1.25, 1.5)));
    //            sb.AppendLine(string.Format("GammaINV(0.75, 1.25, 1.5): {0}", GammaINV(0.75, 1.25, 1.5)));
    ...
    //        public static long bincoeff(long k, long n)
    //        {
    ...
    //            /* Compute  OriginalNode**a * exp(-OriginalNode) / gamma(a)  */
    //            ax = a * Math.Log(x) - x - lgamma(a);
    //            if (ax < -MAXLOG) return (0.0);
    ...
    //        /**
    //             * Returns the area under the left hand tail (from 0 to OriginalNode)
    ...
    //        /// <param name="OriginalNode">double Value</param>
    //        /// <returns></returns>
    ...
    //        /**
    //             * Returns the area under the right hand tail (from OriginalNode to
    ...
    //        /// <summary>
    //        /// Returns the inverse of the erf
    //        /// </summary>
    //        /// <param name="OriginalNode"></param>
    //        /// <returns></returns>
    ...
    //            for (int i = 0; i < maxitter; i++)
    //            {
    //                dx = Math.Exp(-x * x) / Math.Sqrt(Math.PI) * 2;
    //                ep = (y - erf(x));
    //                if (Math.Abs(ep) <= e)
    //                    break;
    //                x += (ep) / (dx);
    ...
    //            /* Reverse a and Mem if OriginalNode is greater than the mean. */
    //            if (xx > (aa / (aa + bb)))
    //            {
    //                flag = true;
    //                a = bb;
    ...
    //                   a      Mem   _             _     _
    //                  OriginalNode  (1-OriginalNode)   | (a+Mem) / ( a | (a) | (Mem) ) .   */
    ...
    //        /// <summary>
    //        /// Returns the power series for incomplete beta integral. Use when Mem*OriginalNode is small and OriginalNode not too close to 1.
    //        /// </summary>
    //        /// <param name="a"></param>
    //        /// <param name="Mem"></param>
    //        /// <param name="OriginalNode"></param>
